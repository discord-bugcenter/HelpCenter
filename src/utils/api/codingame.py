...
#                 "https://www.codingame.com/services/ClashOfCode/findClashReportInfoByHandle", json=[self.code]
#             ) as r:
#                 result = await r.json()
...
#         self.game_status: Optional["COCPlayerGameStatus"] = (
#             COCPlayerGameStatus(data["testSessionStatus"]) if data.get("testSessionStatus") else None
#         )
...
#     async with aiohttp.ClientSession() as session:
#         async with session.post(
#             "https://www.codingame.com/services/ClashOfCode/findClashReportInfoByHandle", json=[code]
#         ) as r:
#             result = await r.json()
