...
def authorized_channels_check(ctx: Union[discord.ApplicationCommandInteraction, commands.Context]) -> bool:
...
def is_high_staff():
    async def inner(ctx: Union[discord.ApplicationCommandInteraction, commands.Context]):
